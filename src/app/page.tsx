...
export default function Home() {
  return <>
    ...
    <main className="home">
      ...
      <section className="section" data-reveal><div className="section-grid"><div className="mono">01 · FOCUS</div><div><h2>Software should feel as considered as it functions.</h2><p className="section-copy">We combine engineering, intelligence and experience design to turn difficult problems into systems people can actually use.</p></div></div></section>
      <section className="section" data-reveal><div className="section-grid"><div className="mono">02 · CAPABILITIES</div><div><h2>Built from the system out.</h2><div className="capabilities">{capabilities.map(([n, title, body]) => <div className="capability" key={n}><span className="mono">{n}</span><div><h3>{title}</h3><p>{body}</p></div><span className="arrow">↗</span></div>)}</div></div></div></section>
      <section className="section" data-reveal><div className="section-grid"><div className="mono">03 · SELECTED WORK</div><div><h2>Experiments becoming products.</h2><div className="work-grid"><a className="work-card" href="/work"><span className="mono">AI / SYSTEMS</span><h3>Intelligent infrastructure</h3><p>Explore the systems we are building and validating.</p></a><a className="work-card" href="/technology"><span className="mono">SOFTWARE / ENGINEERING</span><h3>Production software</h3><p>Architecture, interfaces and infrastructure engineered together.</p></a></div></div></div></section>
